...
public class ActionTest extends AbstractTestClass {
    ...
    public void testActionExecutingOnStateChange() throws Exception {
        ...
        //changing the application into the assessment
        ...
        assertEquals("enterAction executed",app.getShortDescription());

        //changing the application out of the assessment
        ...
        //testing that enterStateAction got executed
        assertEquals("exitAction executed",app.getShortDescription());
    }
