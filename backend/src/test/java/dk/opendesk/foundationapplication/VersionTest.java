...
public class VersionTest extends AbstractTestClass {
    ...
    private void testApplicationHistoryWebScript(NodeRef appRef, String origMail) throws Exception {
        ...
        assertEquals(getWorkflowBean().getState(TestUtils.stateRecievedRef).getTitle(), changeUnits.get(0).getOldValue());
        assertEquals(getWorkflowBean().getState(TestUtils.stateAccessRef).getTitle(), changeUnits.get(0).getNewValue());
        ...
        assertEquals(getWorkflowBean().getState(TestUtils.stateAccessRef).getTitle(), stateChangeUnit.getOldValue());
        assertEquals(getWorkflowBean().getState(TestUtils.stateAcceptedRef).getTitle(), stateChangeUnit.getNewValue());
        assertEquals(APPLICATION_CHANGE_UPDATE_ASSOCIATION, stateChangeUnit.getChangeType());
        ...
        assertEquals(getWorkflowBean().getState(TestUtils.stateAcceptedRef).getTitle(), stateChangeUnit.getOldValue());
