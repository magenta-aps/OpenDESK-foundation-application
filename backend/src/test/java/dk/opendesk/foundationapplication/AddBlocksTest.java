...
public class AddBlocksTest extends AbstractTestClass {
    ...
    public void testAddUniqueBlocks() throws Exception {
        ...
        int noBlocks = foundationBean.getApplication(appRef).getBlocks().size();
        ...
        Action action = serviceRegistry.getActionService().createAction("addBlocks", param);
        serviceRegistry.getActionService().executeAction(action, appRef);

        List<ApplicationPropertiesContainer> actBlocks = foundationBean.getApplication(appRef).getBlocks();
    ...
    public void testAddDuplicateBlock() throws Exception {
        ...
        List<ApplicationPropertiesContainer> oldBlocks = foundationBean.getApplication(appRef).getBlocks();
        for (ApplicationPropertiesContainer b : oldBlocks) {
