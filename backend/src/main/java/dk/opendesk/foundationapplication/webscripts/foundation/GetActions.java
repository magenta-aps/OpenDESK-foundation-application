...
public class GetActions extends JacksonBackedWebscript {
    ...
    protected List<FoundationAction> doAction(WebScriptRequest req, WebScriptResponse res) throws Exception {
        ...
        actions.add(new FoundationAction(ACTION_NAME_ADD_BLOCKS, getFoundationBean().getActionParameters(ACTION_NAME_ADD_BLOCKS)));
        actions.add(new FoundationAction(ACTION_NAME_ADD_FIELDS, getFoundationBean().getActionParameters(ACTION_NAME_ADD_FIELDS)));
