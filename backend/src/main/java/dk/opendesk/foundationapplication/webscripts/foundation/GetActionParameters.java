...
public class GetActionParameters extends JacksonBackedWebscript {
    ...
    @Override
    protected Map<String, String> doAction(WebScriptRequest req, WebScriptResponse res) throws Exception {
        ...
        for (ParameterDefinition paramDef : paramDefs) {
            params.put(paramDef.getName(), paramDef.getType().getPrefixString());
        }
        return params;
    }
}
